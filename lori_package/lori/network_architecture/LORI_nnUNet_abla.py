...
import lori.network_architecture.LORI_SwinUNet as lori
...
class LORI_nnUNet(SegmentationNetwork):
    ...
    def __init__(self, input_channels, base_num_features, num_classes, num_pool, num_conv_per_stage=2,
        ...
        """
        super(LORI_nnUNet, self).__init__()
        print("-----> depths", depths)
        print("-----> dofine", dofine)
        print("-----> vt_num", vt_num)
        # print("\n\n\n\n\nThat's my model !! \n\n\n\n")
        ...
        for ii in range(len(self.input_sizes)):
            if self.do_fine[ii]:
                self.fine_module_list.append( lori.BasicLayer(
