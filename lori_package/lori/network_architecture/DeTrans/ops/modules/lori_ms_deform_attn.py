...
from ..functions.fine_ms_deform_attn_func import lori_ms_deform_attn_core_pytorch_3D

class LoriMSDeformAttn(nn.Module):
    ...
    def forward(self, query, reference_points, input_flatten, input_spatial_shapes, input_level_start_index, input_padding_mask=None):
        ...
        output = lori_ms_deform_attn_core_pytorch_3D(value, input_spatial_shapes, sampling_locations, attention_weights, self.n_vt)
