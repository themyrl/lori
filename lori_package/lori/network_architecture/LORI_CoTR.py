...
import numpy as np
from lori.network_architecture import CNNBackbone
from lori.network_architecture.neural_network_ext import SegmentationNetwork
from lori.network_architecture.DeTrans.LoriDeformableTrans import LoriDeformableTransformer
from lori.network_architecture.DeTrans.position_encoding import build_position_encoding
...
class U_ResTran3D(nn.Module):
    def __init__(self, norm_cfg='BN', activation_cfg='ReLU', img_size=None, num_classes=None, weight_std=False,
        ...
        self.encoder_Detrans = LoriDeformableTransformer(d_model=384, dim_feedforward=1536, dropout=0.1, activation='gelu', num_feature_levels=2, 
...
class LORI_CoTR(SegmentationNetwork):
    """
    ResTran-3D Unet
    """
