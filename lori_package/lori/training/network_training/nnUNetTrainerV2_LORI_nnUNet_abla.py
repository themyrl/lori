...
from lori.network_architecture.LORI_nnUNet_abla import LORI_nnUNet
...
class nnUNetTrainerV2_LORI_nnUNet_abla(nnUNetTrainer):
    """
    ...
    def initialize_network(self):
        ...
        self.network = LORI_nnUNet(self.num_input_channels, self.base_num_features, self.num_classes,
