...
from lori.training.network_training.nnUNetTrainer import nnUNetTrainer
...
from lori.network_architecture.LORI_CoTR import LORI_CoTR
...
def get_n_params(model):
    ...
    for p in list(model.parameters()):
        ...
        pp += nn
    return pp
class nnUNetTrainerV2_LORI_CoTR(nnUNetTrainer):
    ...
    def initialize_network(self):
        ...
        self.network = LORI_CoTR(norm_cfg=self.norm_cfg, activation_cfg=self.activation_cfg, img_size=self.plans['plans_per_stage'][1]['patch_size'],
